...
% Part text styling (this is mostly taken care of in the PART HEADINGS section 
%of this file)
\titlecontents{part}
...
{\hfill\color{black}\thecontentspage} % Formatting of the filler to the right 
%of the heading and the page number
...
%of this type
{} % Formatting of numberless sections of this type
{\ \titlerule*[.5pc]{.}\;\thecontentspage} % Formatting of the filler to the 
%right of the heading and the page number
...
% Subsection text styling (note these aren't shown by default, display them by 
%searchings this file for tocdepth and reading the commented text)
...
\newenvironment{exercise}{\begin{eBox}
        \begin{exerciseT}}{
            \hfill{
                \color{ocre}
                \tiny
...
\newenvironment{remark}{\par\vspace{10pt}
    ...
    \begin{list}{}{
            ...
            sep=2pt,outer sep=0pt] at 
            (-15pt,0pt){\textcolor{ocre}{R}};\end{tikzpicture}} % Orange R in a 
            %circle
...
\newcommand{\@myparttocformat}[1]{%
    ...
    \colorbox{ocre!40}{
        \strut
        \parbox[c][.7cm]{\linewidth}{\Large\sffamily\centering#1}
    }%
}
    ...
    {\thispagestyle{empty}%
        ...
        picture,overlay]%	
            ...
            (\paperwidth-1cm,-\paperheight+1cm){\parbox[t][][t]{8.5cm}{
                    \printcontents{l}{0}{\setcounter{tocdepth}{1}}% The depth 
                    %to which the Part mini table of contents displays 
                    %headings; 
                    %0 for chapters only, 1 for chapters and sections and 2 for 
                    %chapters, sections and subsections
            }};
            \node[anchor=north east] at 
            (\paperwidth-1.5cm,-3.25cm){
                \parbox[t][][t]{15cm}{
                    \strut
                    \raggedleft
                    \color{white}\fontsize{30}{30}\sffamily\bfseries#2}};
            \end{tikzpicture}};
\end{tikzpicture}}%
\@endpart}
\def\@spart#1{%
...
{\begin{tikzpicture}[remember picture,overlay]
    ...
    \draw[anchor=west] (\Gm@lmargin,-9cm) node [line width=2pt,rounded 
